            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        ...
                        <span class="color-text-a">{{$listing->city->name}}</span>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4">
                    <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('front.listings.index')}}">Properties</a>
                            </li>
                            ...
                            <div class="property-price d-flex justify-content-center foo">
                                <div class="card-header-c d-flex">
                                    ...
                                    <div class="card-title-c align-self-center">
                                        <h5 class="title-c">@money($listing->price)</h5>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <img src="{{ asset('img/agent-'.$listing->user->id.'.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <div class="property-agent">
                                <a href="{{route('front.agents.show',$listing->user->id )}}"><h4 class="title-agent">{{$listing->user->name}}</h4></a>
                                <a href="{{route('front.agents.show',$listing->user->id )}}"><p>View Agent Info</p></a>
                                
                                <ul class="list-unstyled">
                                    <li class="d-flex justify-content-between">
                                        <strong>Phone:</strong>
                                        <span class="color-text-a">{{$listing->user->phone}}</span>
                                    </li>
                                   
                                    <li class="d-flex justify-content-between">
                                        <strong>Email:</strong>
                                        <span class="color-text-a">{{$listing->user->email}}</span>
                                    </li>
